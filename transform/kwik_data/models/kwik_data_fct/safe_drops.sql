with stage as (
    select
        ...
        a.store_id,
        a.report_name,
        a.cashier_name::varchar as cashier_name,
        a.register_number::int as register_number,
        case
        ...
        a.drop_amount::numeric as drop_amount,
        a.tender_type::varchar as tender_type,
        a.total_drop::numeric as total_drop,
        a.drop_time::timestamp as drop_time,
