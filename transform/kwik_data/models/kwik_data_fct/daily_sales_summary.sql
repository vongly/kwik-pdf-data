{% set relation = adapter.get_relation(
    ...
    schema=source('kwik_data_raw', 'daily_sales_summary_raw').schema,
    identifier=source('kwik_data_raw', 'daily_sales_summary_raw').name
) %}
...
with stage as (
    ...
    from
        {{ source('kwik_data_raw', 'daily_sales_summary_raw') }} a
